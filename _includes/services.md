...
- Area Chair of AAAI-2026 Workshop *PerFM: Personalization in the Era of LLMs*
- Program committee of ACL, NeurIPS, ICLR, KDD etc.
- Reviewer of IEEE Transactions on Knowledge and Data Engineering (TKDE), IEEE Transactions on Neural Networks and Learning Systems (TNNLS), ACM Computing Surveys (CSUR), ACM Transactions on Information Systems (TOIS), etc.
